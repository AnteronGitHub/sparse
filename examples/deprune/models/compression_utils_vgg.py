...
class EncodingUnit(nn.Module):
    def __init__(self, compressionProps, in_channel = 3):
        super(EncodingUnit, self).__init__()

        compressedChannelNum = int(in_channel / compressionProps['feature_compression_factor'])
        ...
        self.convIn1 = nn.Conv2d(in_channels=in_channel,
...
class DecodingUnit(nn.Module):
    def __init__(self, compressionProps, out_channel = 128):
        super(DecodingUnit, self).__init__()

        compressedChannelNum = int(out_channel / compressionProps['feature_compression_factor'])
