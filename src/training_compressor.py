...
from models.neural_network3 import NeuralNetwork
from models.neural_network3 import NeuralNetwork_local
from models.neural_network3 import NeuralNetwork_server
...
def train(dataloader, model_local, model_server, loss_fn, optimizer_local, optimizer_server, quantizeDtype = torch.float16, realDtype = torch.float32):
    ...
    for batch, (X, y) in enumerate(dataloader):
        ...
        transfererd_split_vals = quantized_split_vals.detach().to('cpu')
...
print(device)
model2 = NeuralNetwork_server(compressionProps).to('cpu')
